...
- Measure it: [RAG Evaluation (grounding, faithfulness, recall@k, MRR)](/ai-ml/ai-ml-learning-resources/llms-applications-and-agents/rag-and-knowledge-systems/rag-evaluation/rag-evaluation) · [Guardrails & Hallucination Mitigation (the support-check, productionized)](/ai-ml/ai-ml-learning-resources/evaluation/hallucination-and-grounding/hallucination-and-grounding)
