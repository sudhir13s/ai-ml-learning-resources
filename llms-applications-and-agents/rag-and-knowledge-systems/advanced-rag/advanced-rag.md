...
> **Source / derivation:** [Self-RAG, Asai et al. 2023 — the `ISSUP` token](https://arxiv.org/abs/2310.11511) — the support/entailment judgement ("is the output supported by the evidence?") this cosine check approximates. The specific proxy — **max cosine of the claim against each retrieved-context sentence** — is ours, a cheap stand-in for the trained token (its limits are measured just below). Source in the [references](/ai-ml/ai-ml-learning-resources/llms-applications-and-agents/rag-and-knowledge-systems/advanced-rag/advanced-rag#references-further-reading).
...
**→ [Advanced RAG (Parent-Document · RAG-Fusion · Self-RAG) — references and further reading](/ai-ml/ai-ml-learning-resources/llms-applications-and-agents/rag-and-knowledge-systems/advanced-rag/advanced-rag#references-further-reading)**
