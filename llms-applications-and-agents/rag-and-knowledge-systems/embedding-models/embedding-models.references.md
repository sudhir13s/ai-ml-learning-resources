...
**In this platform**:
- Concept page (full explanation): [Embedding Models for Retrieval](embedding-models.md)
- Prereqs (the pipeline + chunks this embeds): [01 RAG Fundamentals](../rag-foundations/rag-foundations.md) · [02 Document Chunking Strategies](../chunking/chunking.md)
- Foundations (the *why* behind vectors & similarity): [ai-ml-intuitions 1.02 Dense Embeddings](../../../../ai-ml-intuitions/representation/embedding-spaces/dense-embeddings-intuition.md) · [1.06 Vector Similarities — Scaled Dot-Product](../../../../ai-ml-intuitions/representation/similarity-and-distance/scaled-dot-product-intuition.md) · [06. NLP — Sentence & Document Embeddings](../../../modalities-and-generative-models/natural-language-processing/sentence-and-document-embeddings/sentence-and-document-embeddings.md)
- Next in this domain (search the geometry): [04 Vector Databases & ANN Indexes](../vector-search/vector-search.md) · [05 Hybrid Search (BM25 + Dense)](../hybrid-search/hybrid-search.md) · [06 Re-ranking with Cross-Encoders](../reranking/reranking.md)
