...
- Where ICL is put to work: [RAG & LLM Applications](../../rag-and-knowledge-systems/overview.md) · the [KV cache](../../inference-and-runtime/kv-cache/kv-cache.md) and [long-context methods](../../llm-model-architectures/long-context-architectures/long-context-architectures.md) that make long few-shot prompts affordable
- Decoding that turns the ICL-conditioned distribution into text: [Decoding & Sampling](../../inference-and-runtime/decoding-and-sampling/decoding-and-sampling.md)
