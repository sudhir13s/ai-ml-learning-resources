...
> **Note:** CoT is a *specific* technique — eliciting intermediate **reasoning steps** for multi-step problems. It lives inside the broader topic of **[Prompting & In-Context Learning](/ai-ml/ai-ml-learning-resources/llms-applications-and-agents/reasoning-evaluation-and-alignment/prompting-and-in-context-learning/prompting-and-in-context-learning)** (the general art of conditioning a frozen model at inference time): CoT is *one* prompting technique among many. And the trick of compressing a teacher's reasoning into a smaller model is **CoT distillation**, covered under **[Knowledge Distillation](/ai-ml/ai-ml-learning-resources/llms-applications-and-agents/training-and-adaptation/knowledge-distillation/knowledge-distillation)** — we point there rather than absorb it. This page is just about the reasoning-step technique itself.
...
- **CoT distillation for cheap reasoning.** To get reasoning ability at a smaller model's cost, teams distill a large model's chains into a small one (see [Knowledge Distillation](/ai-ml/ai-ml-learning-resources/llms-applications-and-agents/training-and-adaptation/knowledge-distillation/knowledge-distillation)).
...
**→ [Chain-of-Thought Reasoning — references and further reading](/ai-ml/ai-ml-learning-resources/llms-applications-and-agents/reasoning-evaluation-and-alignment/chain-of-thought-and-reasoning/chain-of-thought-and-reasoning#references-further-reading)**
