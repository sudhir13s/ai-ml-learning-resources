...
4. **Watch it run** — watch [Let's build a ReAct agent (LangGraph)](https://www.youtube.com/watch?v=uRya4zRrRx4) (**LangChain**). *The loop executing against real tools, with the termination condition made explicit — including where it breaks.*
...
- [Let's build a ReAct agent (LangGraph)](https://www.youtube.com/watch?v=uRya4zRrRx4) — **LangChain** — the loop expressed as a graph with tool nodes and an explicit termination condition; closest to this chapter's build.
...
- [How We Build Effective Agents](https://www.youtube.com/watch?v=D7_ipDqhtwk) — **Barry Zhang (Anthropic), AI Engineer** — situates ReAct-style loops among production agent patterns; when to use which.
- [Building Agents with Model Context Protocol — full workshop](https://www.youtube.com/watch?v=kQmXtrmQ5Zg) — **Mahesh Murag (Anthropic), AI Engineer** — the `Action` half of the loop as it is actually served in production, rather than parsed out of free text.
...
- Fast recall layer: the AI buzzwords cards on Agents, Agentic Workflows, and Tool Use & MCP cover the same vocabulary in one screen each.
- Prerequisite (the reasoning half): [Chain-of-Thought Reasoning](/ai-ml/ai-ml-learning-resources/models-and-architectures/large-language-models/chain-of-thought-and-reasoning/chain-of-thought-and-reasoning) · prompting foundations in [09 LLMs — Prompting](/ai-ml/ai-ml-learning-resources/llms-applications-and-agents/readme)
