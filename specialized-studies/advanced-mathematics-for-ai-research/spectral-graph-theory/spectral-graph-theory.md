...
- Where this math is applied today: [Graph Neural Networks](/ai-ml/ai-ml-learning-resources/deep-learning/scientific-and-specialized-deep-learning/graph-neural-networks/graph-neural-networks) — the Laplacian eigenbasis is the spectral view of graph convolution.
