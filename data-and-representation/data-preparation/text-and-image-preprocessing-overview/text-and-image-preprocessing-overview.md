...
1. **Text basics** — read [Speech and Language Processing, Ch. 2](https://web.stanford.edu/~jurafsky/slp3/2.pdf) — **Jurafsky & Martin**. *Regular expressions, normalization, stemming and edit distance: the classical cleaning pipeline, stated precisely.*
2. **Modern tokenization** — watch [Let's build the GPT Tokenizer](https://www.youtube.com/watch?v=zduSFxRajkE) — **Andrej Karpathy**. *The subword tokenization behind today's models, built from bytes upward.*
3. **Image basics** — read [CS231n: Setting up the data](https://cs231n.github.io/neural-networks-2/) — **Stanford**. *Mean subtraction, per-channel normalization, and why whitening is usually skipped in practice.*
...
## Courses (free)
- [Hugging Face LLM Course — Tokenizers](https://huggingface.co/learn/llm-course/chapter6/1) — **Hugging Face** — the definitive free course chapter on modern text tokenization, updated in 2025.
...
## Videos
- [Let's build the GPT Tokenizer](https://www.youtube.com/watch?v=zduSFxRajkE) — **Andrej Karpathy** — byte-pair encoding built from scratch; the definitive account of what modern text preprocessing actually is, including the Unicode and whitespace traps.
- [Byte Pair Encoding](https://www.youtube.com/watch?v=tOMjTCO0htA) — **From Languages to Information (Dan Jurafsky, Stanford)** — the short lecture version of the same algorithm.
- [Hugging Face Course (full playlist)](https://www.youtube.com/playlist?list=PLo2EIpI_JMQvWfQndUesu0nPBAtZ9gP1o) — **Hugging Face** — the tokenizers chapter: normalization, pre-tokenization, model and post-processing, from the maintainers.
- [PyTorch Data Augmentation using Torchvision](https://www.youtube.com/watch?v=Zvd276j9sZ8) — **Aladdin Persson** — train-time image augmentation transforms in practice.
...
- Full depth lives in the dedicated domains:
  - **Text** — tokenization, normalization, subword algorithms → [06. NLP](/ai-ml/ai-ml-learning-resources/multimodal-and-generative-media/natural-language-processing/readme)
  - **Images** — augmentation and vision-specific preprocessing → [07. Computer Vision](/ai-ml/ai-ml-learning-resources/multimodal-and-generative-media/computer-vision/readme)
...
- Next concepts: [06 Feature Engineering](/ai-ml/ai-ml-learning-resources/data-and-representation/data-preparation/feature-engineering/feature-engineering) · [13 Data Pipelines](/ai-ml/ai-ml-learning-resources/data-and-representation/data-preparation/data-pipelines/data-pipelines)
