...
3. [Embedding Models](/ai-ml/ai-ml-learning-resources/data-and-representation/embedding-models/embedding-models) — **2 pages** — how contrastive training builds the model that decides what is near what, and the similarity-search framing interviews use.

Tokenization is taught where the modality lives, in [Tokenization and Subword Algorithms](/ai-ml/ai-ml-learning-resources/multimodal-and-generative-media/natural-language-processing/tokenization-and-subword-algorithms/tokenization-and-subword-algorithms).
...
- Curating a real training corpus, gate by gate: [Curating a Web Corpus](/ai-ml/ai-ml-learning-resources/data-and-representation/synthetic-data-and-curation/synthetic-data-and-curation-curating-a-web-corpus)
...
**Courses**:
- [Machine Learning Specialization](https://www.coursera.org/specializations/machine-learning-introduction) — **Andrew Ng / DeepLearning.AI** — the feature-engineering and data-handling lectures are the canonical first pass.
...
**Books**:
- [*An Introduction to Statistical Learning*](https://www.statlearning.com/) — **James, Witten, Hastie and Tibshirani** — PDF with Python labs; the applied text under every preparation page.
