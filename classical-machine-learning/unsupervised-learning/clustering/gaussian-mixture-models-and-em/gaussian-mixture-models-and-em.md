...
*Measured, not illustrative: this is `compare_shape` in [`code/gmm_em.py`](code/gmm_em.py) on the same sheared blobs k-means fails on in [chapter 01](/ai-ml/ai-ml-learning-resources/classical-machine-learning/unsupervised-learning/clustering/k-means-clustering/k-means-clustering) — GMM ARI 1.00, k-means ARI 0.66. Open [the notebook](code/gaussian-mixture-models-and-em.ipynb) (Step 10) to run it yourself.*
...
- **Anomaly / novelty detection** — fit a GMM to "normal" data and flag points with low $p(x)$ (a common alternative to one-class SVM / isolation forest); see [Anomaly & Outlier Detection](/ai-ml/ai-ml-learning-resources/classical-machine-learning/unsupervised-learning/anomaly-detection/anomaly-outlier-detection/anomaly-outlier-detection).
...
- **Initialization & embeddings** — clustering learned embeddings (after [t-SNE](/ai-ml/ai-ml-learning-resources/classical-machine-learning/unsupervised-learning/dimensionality-reduction/t-sne/t-sne)/[UMAP](/ai-ml/ai-ml-learning-resources/classical-machine-learning/unsupervised-learning/dimensionality-reduction/umap/umap) or an autoencoder) where soft, elliptical clusters beat hard spheres.
...
- **Non-convex / weird shapes** (crescents, rings, intertwined spirals): a GMM tries to wrap ellipses around them and fails. Use **density-based** [DBSCAN](/ai-ml/ai-ml-learning-resources/classical-machine-learning/unsupervised-learning/clustering/dbscan/dbscan) (follows arbitrary shapes, no $K$ needed) or [spectral clustering](/ai-ml/ai-ml-learning-resources/classical-machine-learning/unsupervised-learning/clustering/spectral-clustering/spectral-clustering) (clusters by graph connectivity).
...
- **Very high dimensions**: `full` covariance's $d^2$ parameters explode and overfit; either restrict to `diag`/`tied`, reduce dimensionality first ([dimensionality reduction](/ai-ml/ai-ml-learning-resources/classical-machine-learning/unsupervised-learning/dimensionality-reduction/dimensionality-reduction-overview/dimensionality-reduction-overview)/[UMAP](/ai-ml/ai-ml-learning-resources/classical-machine-learning/unsupervised-learning/dimensionality-reduction/umap/umap)), or use a different model.
- **Purely hard labels, speed-critical**: if you don't need soft assignments or a density and clusters are roundish, plain [k-means](/ai-ml/ai-ml-learning-resources/classical-machine-learning/unsupervised-learning/clustering/k-means-clustering/k-means-clustering) is simpler and faster.
...
- **Non-Gaussian or non-convex clusters** → GMMs assume Gaussian components; for crescents/rings/arbitrary shapes use density-based ([DBSCAN](/ai-ml/ai-ml-learning-resources/classical-machine-learning/unsupervised-learning/clustering/dbscan/dbscan)) or [spectral clustering](/ai-ml/ai-ml-learning-resources/classical-machine-learning/unsupervised-learning/clustering/spectral-clustering/spectral-clustering) instead.
...
**→ [Gaussian Mixture Models & EM — references and further reading](/ai-ml/ai-ml-learning-resources/classical-machine-learning/unsupervised-learning/clustering/gaussian-mixture-models-and-em/gaussian-mixture-models-and-em#references-further-reading)**
