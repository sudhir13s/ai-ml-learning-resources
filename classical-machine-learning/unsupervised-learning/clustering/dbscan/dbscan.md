...
> **Tip:** the cheat-sheet for "which clustering algorithm?": **round, balanced blobs and you know `k`** → [k-means](/ai-ml/ai-ml-learning-resources/classical-machine-learning/unsupervised-learning/clustering/k-means-clustering/k-means-clustering). **Weird shapes + outliers, don't know `k`** → DBSCAN. **Overlapping clusters, want soft/probabilistic membership or elliptical clusters** → [GMM](/ai-ml/ai-ml-learning-resources/classical-machine-learning/unsupervised-learning/clustering/gaussian-mixture-models-and-em/gaussian-mixture-models-and-em). **Want a full hierarchy / dendrogram or small `n`** → [agglomerative](/ai-ml/ai-ml-learning-resources/classical-machine-learning/unsupervised-learning/clustering/hierarchical-clustering/hierarchical-clustering). **Weird shapes + *varying* density** → HDBSCAN.
...
**→ [DBSCAN — references and further reading](/ai-ml/ai-ml-learning-resources/classical-machine-learning/unsupervised-learning/clustering/dbscan/dbscan#references-further-reading)**
