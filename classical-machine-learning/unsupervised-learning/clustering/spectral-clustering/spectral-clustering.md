...
Picture two interlocking crescent moons of dots, or two concentric rings — an inner circle of points wrapped by an outer one. Ask [k-means](/ai-ml/ai-ml-learning-resources/classical-machine-learning/unsupervised-learning/clustering/k-means-clustering/k-means-clustering) to split them into two clusters and it fails badly: it slices a straight line through the middle, putting half of each moon in the wrong group. It can't help it. K-means asks *"which center is each point closest to?"*, and "closest to a center" only carves out **convex blobs** — round, ball-shaped regions. The two moons are not blobs. Neither are the rings. The structure your eye sees isn't *"near a center"*; it's *"connected to its neighbors along a curve."*
...
- **Manifold learning and embeddings.** Because the Laplacian eigenvectors *are* a low-dimensional embedding, the same machinery powers **Laplacian Eigenmaps**, **diffusion maps**, and is a conceptual ancestor of [t-SNE](/ai-ml/ai-ml-learning-resources/classical-machine-learning/unsupervised-learning/dimensionality-reduction/t-sne/t-sne) and [UMAP](/ai-ml/ai-ml-learning-resources/classical-machine-learning/unsupervised-learning/dimensionality-reduction/umap/umap). When someone says "spectral methods," they mean this family — embed via the graph's spectrum, then visualize or cluster.
...
|---|---|---|---|---|---|---|
| **[k-means](/ai-ml/ai-ml-learning-resources/classical-machine-learning/unsupervised-learning/clustering/k-means-clustering/k-means-clustering)** | distance to centroid | ❌ convex only | yes | $O(nki)$ — cheap | no | spherical, equal-size blobs |
| **[GMM / EM](/ai-ml/ai-ml-learning-resources/classical-machine-learning/unsupervised-learning/clustering/gaussian-mixture-models-and-em/gaussian-mixture-models-and-em)** | likelihood under Gaussians | ⚠️ elliptical only | yes | $O(nk d^2 i)$ | soft | Gaussian components |
| **[DBSCAN](/ai-ml/ai-ml-learning-resources/classical-machine-learning/unsupervised-learning/clustering/dbscan/dbscan)** | density-connectivity | ✅ yes | no (uses ε, minPts) | $O(n\log n)$ w/ index | ✅ yes | uniform density per cluster |
...
**→ [Spectral Clustering — references and further reading](/ai-ml/ai-ml-learning-resources/classical-machine-learning/unsupervised-learning/clustering/spectral-clustering/spectral-clustering#references-further-reading)**
