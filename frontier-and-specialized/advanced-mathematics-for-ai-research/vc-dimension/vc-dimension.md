...
5. **Push to data-dependent capacity** — see why VC can be loose for deep nets, then move to [Rademacher complexity](/ai-ml/ai-ml-learning-resources/frontier-and-specialized/advanced-mathematics-for-ai-research/rademacher-complexity-and-generalization-bounds/rademacher-complexity-and-generalization-bounds). *VC is worst-case; Rademacher is the tighter, distribution-aware successor.*
