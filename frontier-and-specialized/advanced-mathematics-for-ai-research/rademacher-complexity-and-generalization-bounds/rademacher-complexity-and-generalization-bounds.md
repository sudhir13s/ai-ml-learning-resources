...
2. **See the symmetrization trick** — work §3.8 (Rademacher complexity) of the same [CS229T notes](https://web.stanford.edu/class/cs229t/notes.pdf). *Symmetrization is the one idea that defines Rademacher complexity.*
...
- [Learning with Infinite Hypothesis Sets — lecture slides](https://cs.nyu.edu/~mohri/mls/ml_learning_with_infinite_hypothesis_sets.pdf) — **Mehryar Mohri (NYU / Google Research)** — the symmetrization argument, Massart's finite lemma and the contraction lemma on slides, in the same notation as the book.
...
- Foundations (the basics this builds on): [Law of Large Numbers & the CLT](/ai-ml/ai-ml-learning-resources/foundations/mathematical-foundations/lln-and-clt/lln-and-clt) · [Expectation, Variance & Covariance](/ai-ml/ai-ml-learning-resources/foundations/mathematical-foundations/expectation-variance-covariance/expectation-variance-covariance)
- Prerequisite & next: [05 Statistical Learning Theory (PAC)](/ai-ml/ai-ml-learning-resources/frontier-and-specialized/advanced-mathematics-for-ai-research/statistical-learning-theory-pac/statistical-learning-theory-pac) · [06 VC Dimension](/ai-ml/ai-ml-learning-resources/frontier-and-specialized/advanced-mathematics-for-ai-research/vc-dimension/vc-dimension) · [01 Measure Theory & Probability](/ai-ml/ai-ml-learning-resources/frontier-and-specialized/advanced-mathematics-for-ai-research/measure-theory-and-probability-foundations/measure-theory-and-probability-foundations)
