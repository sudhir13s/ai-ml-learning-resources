...
- [Flow Matching Guide and Code](https://arxiv.org/abs/2412.06264) — **Lipman, Chen, Ben-Hamu, Gat et al. (Meta FAIR, 2024)** — the self-contained review of the training objective that now drives 2026 image, video and audio generation; optimal transport is the coupling that makes its paths straight.
- [Improving and Generalizing Flow-Based Generative Models with Minibatch Optimal Transport](https://arxiv.org/abs/2302.00482) — **Tong, Fatras, Malkin et al. (2023)** — makes the OT link explicit: pairing samples by an OT plan straightens trajectories and cuts sampling steps.
...
- Prerequisite & next: [04 Convex Analysis & Duality](/ai-ml/ai-ml-learning-resources/frontier-and-specialized/advanced-mathematics-for-ai-research/convex-analysis-and-duality/convex-analysis-and-duality) · [08 Information Geometry](/ai-ml/ai-ml-learning-resources/frontier-and-specialized/advanced-mathematics-for-ai-research/information-geometry/information-geometry)
- Where this math is applied today: [Flow Matching & Rectified Flow](/ai-ml/ai-ml-learning-resources/models-and-architectures/generative-model-families/diffusion-models/flow-matching-and-rectified-flow/flow-matching-and-rectified-flow) — optimal transport is its mathematical spine.
