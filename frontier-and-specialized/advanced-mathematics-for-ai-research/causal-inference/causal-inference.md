...
5. **Connect to ML & decisions** — watch [1.1 Intro & Outline](https://www.youtube.com/watch?v=CfzO4IEMVUk) and link to bandits/RL via the [Game Theory card](/ai-ml/ai-ml-learning-resources/frontier-and-specialized/advanced-mathematics-for-ai-research/game-theory-and-multi-agent-math/game-theory-and-multi-agent-math). *Causality underpins off-policy evaluation and counterfactual learning.*
...
- [Bandit Algorithms (free book)](https://tor-lattimore.com/downloads/book/book.pdf) — **Lattimore & Szepesvári** — the decision-theoretic neighbor (interventions over time), fully free from the author.
- [DoWhy user guide](https://www.pywhy.org/dowhy/) — **PyWhy (Microsoft Research + Amazon)** — the 2026 practitioner path: model → identify → estimate → refute, with the refutation tests that catch a bad identification claim.
...
- [Toward Causal Representation Learning](https://arxiv.org/abs/2102.11107) — **Schölkopf, Locatello, Bauer, Ke, Kalchbrenner, Goyal & Bengio (2021)** — the agenda that fused causality with deep representation learning; the paper the 2025 wave builds on.
- [Towards Interpretable Deep Generative Models via Causal Representation Learning](https://arxiv.org/abs/2504.11609) — **Moran & Aragam (2025)** — a current review of where causal representation learning stands, including identifiability results and open statistical questions.
...
- [EconML documentation](https://econml.azurewebsites.net/) — **Microsoft Research ALICE team** — heterogeneous treatment effects with machine learning (double ML, causal forests, meta-learners): the estimator side of the DoWhy workflow.
...
- Prerequisite & next: [01 Measure Theory & Probability](/ai-ml/ai-ml-learning-resources/frontier-and-specialized/advanced-mathematics-for-ai-research/measure-theory-and-probability-foundations/measure-theory-and-probability-foundations) · [15 Game Theory & Multi-Agent Math](/ai-ml/ai-ml-learning-resources/frontier-and-specialized/advanced-mathematics-for-ai-research/game-theory-and-multi-agent-math/game-theory-and-multi-agent-math)
- Related domain (sequential decisions): [10. Reinforcement Learning](/ai-ml/ai-ml-learning-resources/reinforcement-learning/readme)
