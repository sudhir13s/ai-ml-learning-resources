...
- [Active Inference (Parr, Pezzulo & Friston) — Chapter 1 walkthrough](https://www.youtube.com/watch?v=spYhr_SdqOw) — **Active Inference Institute** — a chapter-by-chapter read of the standard textbook, starting from why perception and action share one objective.
...
- Prereqs in this section: [06 Predictive Coding](/ai-ml/ai-ml-learning-resources/frontier-and-specialized/neuroscience-and-brain-inspired-ai/predictive-coding/predictive-coding)
