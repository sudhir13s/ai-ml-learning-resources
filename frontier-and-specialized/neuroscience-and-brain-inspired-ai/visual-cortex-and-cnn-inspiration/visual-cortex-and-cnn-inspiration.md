...
5. **Go deeper on the hierarchy** — explore the [Computer Vision](/ai-ml/ai-ml-learning-resources/multimodal-and-generative-media/computer-vision/readme) architectures that extend V1→IT into deep nets.
...
- Next concepts: [06 Predictive Coding](/ai-ml/ai-ml-learning-resources/frontier-and-specialized/neuroscience-and-brain-inspired-ai/predictive-coding/predictive-coding)
