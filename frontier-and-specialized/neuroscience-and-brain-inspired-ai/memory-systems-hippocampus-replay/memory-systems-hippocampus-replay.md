...
5. **Connect to ML** — link replay to [experience replay](/ai-ml/ai-ml-learning-resources/reinforcement-learning/readme) and continual learning. *Same idea: replay past experience to learn stably.*
...
- Prereqs in this section: [04 Hebbian Learning & STDP](/ai-ml/ai-ml-learning-resources/frontier-and-specialized/neuroscience-and-brain-inspired-ai/hebbian-learning-and-stdp/hebbian-learning-and-stdp) · [09 Dopamine & RL in the Brain](/ai-ml/ai-ml-learning-resources/frontier-and-specialized/neuroscience-and-brain-inspired-ai/dopamine-and-rl-in-the-brain/dopamine-and-rl-in-the-brain)
- Next concepts: [11 Attention & Working Memory (biological)](/ai-ml/ai-ml-learning-resources/frontier-and-specialized/neuroscience-and-brain-inspired-ai/attention-and-working-memory-biological/attention-and-working-memory-biological)
- Where this idea is applied today: [Agent Memory](/ai-ml/ai-ml-learning-resources/llms-applications-and-agents/agentic-ai/memory/memory) — the episodic / semantic / working split that 2026 agent memory systems use is borrowed straight from this literature, consolidation step included.
- Related domain: [10. Reinforcement Learning](/ai-ml/ai-ml-learning-resources/reinforcement-learning/readme)
