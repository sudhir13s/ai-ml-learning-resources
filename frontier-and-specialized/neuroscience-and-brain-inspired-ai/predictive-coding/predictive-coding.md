...
1. **Build intuition** — watch [Is Reality a Controlled Hallucination?](https://www.youtube.com/watch?v=qXcH26M7PQM) with Anil Seth. *The prediction-error mental model before any math, from a co-author of the field's standard review.*
...
## Videos
- [Is Reality a Controlled Hallucination? — with Anil Seth](https://www.youtube.com/watch?v=qXcH26M7PQM) — **The Royal Institution** — top-down prediction and bottom-up error told through perception, by one of the review's own authors.
...
- Prereqs in this section: [08 Visual Cortex & CNN Inspiration](/ai-ml/ai-ml-learning-resources/frontier-and-specialized/neuroscience-and-brain-inspired-ai/visual-cortex-and-cnn-inspiration/visual-cortex-and-cnn-inspiration)
- Next concepts: [07 Free Energy Principle / Active Inference](/ai-ml/ai-ml-learning-resources/frontier-and-specialized/neuroscience-and-brain-inspired-ai/free-energy-principle-active-inference/free-energy-principle-active-inference) · [14 Biologically-Plausible Backprop Alternatives](/ai-ml/ai-ml-learning-resources/frontier-and-specialized/neuroscience-and-brain-inspired-ai/biologically-plausible-backprop-alternatives/biologically-plausible-backprop-alternatives)
- Where this idea is applied today: [JEPA Foundations](/ai-ml/ai-ml-learning-resources/world-models-and-embodied-ai/predictive-representation-models/jepa-foundations/jepa-foundations) — joint-embedding predictive architectures predict in latent space rather than pixel space, the same "predict, then keep only the error" bargain.
