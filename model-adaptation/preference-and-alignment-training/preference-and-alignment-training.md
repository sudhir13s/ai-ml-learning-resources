...
**Where this went in 2025-26.** The centre of gravity moved from *preference* rewards to **verifiable** ones. Instead of asking a learned reward model which answer a human would prefer, you ask a checker whether the answer is *correct* — a unit test passes, a math answer matches, a proof type-checks — and optimize that with GRPO. [DeepSeek-R1](https://arxiv.org/abs/2501.12948) showed long reasoning chains emerging from this alone, and [Tülu 3](https://arxiv.org/abs/2411.15124) published the full open recipe combining SFT, DPO, and reinforcement learning with verifiable rewards (RLVR). That line has its own page: [Reinforcement Learning for Reasoning (GRPO and RLVR)](/ai-ml/ai-ml-learning-resources/model-adaptation/reinforcement-learning-posttraining/reinforcement-learning-posttraining). The distinction to state in an interview: **RLHF optimizes a model of taste; RLVR optimizes a fact you can check** — which is why RLVR does not suffer reward-model over-optimization, and why it only applies where a checker exists.
...
**→ [RLHF & DPO — references and further reading](/ai-ml/ai-ml-learning-resources/model-adaptation/preference-and-alignment-training/preference-and-alignment-training#references-further-reading)**
