...
- Preference alignment end to end, from preference data to a running DPO or PPO job: [Preference and Alignment Training](/ai-ml/ai-ml-learning-resources/model-adaptation/preference-and-alignment-training/preference-and-alignment-training) · where the instruction data itself comes from: [Synthetic Data and Data Curation](/ai-ml/ai-ml-learning-resources/data-and-representation/synthetic-data-and-curation/synthetic-data-and-curation) · The production spine the chat build points at: [small-chat-model](/python/python-production-examples/small-chat-model/readme)
