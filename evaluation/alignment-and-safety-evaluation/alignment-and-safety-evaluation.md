...
A different lever, drawn straight from [chain-of-thought reasoning](/ai-ml/ai-ml-learning-resources/models-and-architectures/large-language-models/chain-of-thought-and-reasoning/chain-of-thought-and-reasoning): instead of trusting one sample, draw **many** and look for agreement.
...
You cannot fix what you cannot measure, and hallucination metrics split along the taxonomy axis — **faithfulness** (vs a source) and **factuality** (vs the world). From [LLM evaluation & benchmarks](/ai-ml/ai-ml-learning-resources/evaluation/model-evaluation-and-benchmarks/model-evaluation-and-benchmarks) (chapter 19):
...
- **Architecture & serving (4–12):** [KV cache](/ai-ml/ai-ml-learning-resources/inference-and-serving/kv-cache/kv-cache), [quantization](/ai-ml/ai-ml-learning-resources/inference-and-serving/quantization/quantization), and [LoRA](/ai-ml/ai-ml-learning-resources/model-adaptation/lora-and-parameter-efficient-fine-tuning/lora-and-parameter-efficient-fine-tuning) are about *speed and memory* — but an over-aggressive quantized cache can *degrade* outputs into more errors, and [long-context methods](/ai-ml/ai-ml-learning-resources/models-and-architectures/large-language-models/long-context-architectures/long-context-architectures) are what make **grounding** (stuffing retrieved documents into the prompt) physically possible. The infrastructure is the substrate the fixes run on.
- **Post-training (13–15):** [SFT](/ai-ml/ai-ml-learning-resources/model-adaptation/supervised-fine-tuning/supervised-fine-tuning), [instruction tuning](/ai-ml/ai-ml-learning-resources/model-adaptation/instruction-tuning/instruction-tuning), and [RLHF/DPO](/ai-ml/ai-ml-learning-resources/model-adaptation/preference-and-alignment-training/preference-and-alignment-training) are where **honesty is taught or amplified** — the incentive lever, for better or worse.
- **Use & measurement (16–19):** [prompting](/ai-ml/ai-ml-learning-resources/models-and-architectures/large-language-models/prompting-and-in-context-learning/prompting-and-in-context-learning) and [chain-of-thought](/ai-ml/ai-ml-learning-resources/models-and-architectures/large-language-models/chain-of-thought-and-reasoning/chain-of-thought-and-reasoning) enable **self-consistency**; [decoding](/ai-ml/ai-ml-learning-resources/inference-and-serving/decoding-and-sampling/decoding-and-sampling) is the temperature lever; [evaluation](/ai-ml/ai-ml-learning-resources/evaluation/model-evaluation-and-benchmarks/model-evaluation-and-benchmarks) is how you *know* any of it worked.
