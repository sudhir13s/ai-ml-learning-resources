...
# Hallucination & Alignment Basics — references

> Companion link library for **[Hallucination & Alignment Basics](/ai-ml/ai-ml-learning-resources/evaluation/alignment-and-safety-evaluation/alignment-and-safety-evaluation)** (the teaching page). External sources and internal links, grouped by type, alphabetical within each group.
...
5. **Connect the fixes** — [RLHF & DPO](/ai-ml/ai-ml-learning-resources/model-adaptation/preference-and-alignment-training/preference-and-alignment-training) (preference tuning) + [RAG](/ai-ml/practitioner-workflows/llm-applications/rag-foundations/rag-foundations) (grounding) + [Decoding & Sampling](/ai-ml/ai-ml-learning-resources/inference-and-serving/decoding-and-sampling/decoding-and-sampling) (temperature). *The main levers, each its own chapter.*

**In this platform**:
- [Chain-of-Thought Reasoning](/ai-ml/ai-ml-learning-resources/models-and-architectures/large-language-models/chain-of-thought-and-reasoning/chain-of-thought-and-reasoning) — the mechanism of the fixes.
- [Decoding & Sampling](/ai-ml/ai-ml-learning-resources/inference-and-serving/decoding-and-sampling/decoding-and-sampling) — the mechanism of the fixes.
- [Hallucination & Alignment Basics](/ai-ml/ai-ml-learning-resources/evaluation/alignment-and-safety-evaluation/alignment-and-safety-evaluation) — concept page (full explanation).
- [Instruction Tuning](/ai-ml/ai-ml-learning-resources/model-adaptation/instruction-tuning/instruction-tuning) — where the disease starts.
- [KV Cache](/ai-ml/ai-ml-learning-resources/inference-and-serving/kv-cache/kv-cache) — capstone context (the full arc).
- [Language Modeling Objectives](/ai-ml/ai-ml-learning-resources/models-and-architectures/large-language-models/language-modeling-objectives/language-modeling-objectives) — where the disease starts.
- [LLM Evaluation & Benchmarks](/ai-ml/ai-ml-learning-resources/evaluation/model-evaluation-and-benchmarks/model-evaluation-and-benchmarks) — how it's measured.
- [Long-Context Methods](/ai-ml/ai-ml-learning-resources/models-and-architectures/large-language-models/long-context-architectures/long-context-architectures) — capstone context (the full arc).
- [LoRA & PEFT](/ai-ml/ai-ml-learning-resources/model-adaptation/lora-and-parameter-efficient-fine-tuning/lora-and-parameter-efficient-fine-tuning) — capstone context (the full arc).
- [Module 6.03 PPO and RLHF](/ai-ml/ai-ml-intuitions/decision-making-and-control/stable-policy-optimization/ppo-and-rl-from-human-feedback-intuition) — deeper RL grounding.
- [Quantization](/ai-ml/ai-ml-learning-resources/inference-and-serving/quantization/quantization) — capstone context (the full arc).
- [RAG & LLM Applications](/ai-ml/practitioner-workflows/llm-applications/rag-foundations/rag-foundations) — the mechanism of the fixes.
- [RLHF & DPO](/ai-ml/ai-ml-learning-resources/model-adaptation/preference-and-alignment-training/preference-and-alignment-training) — the mechanism of the fixes.
- [Supervised Fine-Tuning](/ai-ml/ai-ml-learning-resources/model-adaptation/supervised-fine-tuning/supervised-fine-tuning) — where the disease starts.
