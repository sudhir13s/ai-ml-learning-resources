...
minutes: 20
category: evaluation
core_idea: "Good retrieval does not make a RAG system safe: input rails screen injected instructions and PII before generation, output rails abstain when an answer is not grounded, and every threshold trades false refusals against false allows."
---
...
> Carried from [ch11](/ai-ml/practitioner-workflows/llm-applications/rag-evaluation/rag-evaluation)/[ch13](/ai-ml/practitioner-workflows/llm-applications/citations-and-attribution/citations-and-attribution):
...
animated SVG (loops).](images/rag14_guardrail_flow.svg)
...
passage — the same encoder-cosine support proxy from [ch11](/ai-ml/practitioner-workflows/llm-applications/rag-evaluation/rag-evaluation)/[ch13](/ai-ml/practitioner-workflows/llm-applications/citations-and-attribution/citations-and-attribution):
...
The curated link library for this topic — in this platform, videos, courses, interactive, articles, papers, documentation, books, resources — lives in a companion file so it can be reused as a standalone reference list:

**→ [Guardrails & Hallucination Mitigation — references](/ai-ml/ai-ml-learning-resources/evaluation/hallucination-and-grounding/hallucination-and-grounding#references-further-reading)**
