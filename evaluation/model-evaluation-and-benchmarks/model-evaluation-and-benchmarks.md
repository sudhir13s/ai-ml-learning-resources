...
- **RLHF / DPO depend on a reward signal** that *is* an evaluation — a Bradley–Terry preference model. Eval and alignment are the same math wearing different hats (see [RLHF & DPO](/ai-ml/ai-ml-learning-resources/model-adaptation/preference-and-alignment-training/preference-and-alignment-training)).
...
**→ [LLM Evaluation & Benchmarks — references and further reading](/ai-ml/ai-ml-learning-resources/evaluation/model-evaluation-and-benchmarks/model-evaluation-and-benchmarks#references-further-reading)**
