...
5. **Make it concrete** — read the [WGAN-GP paper's algorithm box](https://arxiv.org/abs/1704.00028) and implement the critic loop against it. *Coding the critic, the `n_critic` inner steps, and the gradient penalty makes the Lipschitz constraint tangible.*
6. **See where this went in 2025–26** — read [The GAN is dead; long live the GAN! (R3GAN)](https://arxiv.org/abs/2501.05441) — **Huang et al. (2025)**. *A relativistic loss with zero-centred gradient penalties, proven to converge — the modern replacement for the stack of stabilization tricks on this page.*
...
- [Lecture 20: Generative Models II (EECS 498)](https://www.youtube.com/watch?v=igP03FXZqgo) — **Michigan Online (Justin Johnson)** — GAN training dynamics, mode collapse, and the objective variants, taught as a lecture rather than a code-along.
...
- [The GAN is dead; long live the GAN! A Modern GAN Baseline (R3GAN)](https://arxiv.org/abs/2501.05441) — **Huang et al. (2025)** — a relativistic pairing loss with zero-centred penalties and a convergence proof; removes almost every stabilization heuristic in the 2017-era playbook.
...
- Prereq: [02 GANs & DCGAN](/ai-ml/ai-ml-learning-resources/models-and-architectures/generative-model-families/generative-models/gans-and-dcgan/gans-and-dcgan) (the base game this card fixes)
- Next concepts: [04 Conditional Generation & Classifier-Free Guidance](/ai-ml/ai-ml-learning-resources/models-and-architectures/generative-model-families/diffusion-models/conditional-generation-and-classifier-free-guidance/conditional-generation-and-classifier-free-guidance) · [12 Evaluation of Generative Models](/ai-ml/ai-ml-learning-resources/models-and-architectures/generative-model-families/generative-models/evaluation-of-generative-models/evaluation-of-generative-models) (how to measure collapse)
