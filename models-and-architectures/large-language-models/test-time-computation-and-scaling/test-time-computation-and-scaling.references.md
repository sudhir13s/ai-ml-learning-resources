---
id: "models-and-architectures/large-language-models/test-time-computation-and-scaling/references"
topic: "Test-Time Computation and Scaling — References"
parent: "models-and-architectures/large-language-models/test-time-computation-and-scaling"
type: references
updated: 2026-09-14
---

# Test-Time Computation and Scaling — references

> Companion link library for **[Test-Time Computation and Scaling](/ai-ml/ai-ml-learning-resources/models-and-architectures/large-language-models/test-time-computation-and-scaling/test-time-computation-and-scaling)** (the teaching page). External sources and internal links, grouped by type, alphabetical within each group.
...
- How the ability is trained in the first place: [Reinforcement Learning for Reasoning](/ai-ml/ai-ml-learning-resources/model-adaptation/reinforcement-learning-posttraining/reinforcement-learning-posttraining) · [Preference and Alignment Training](/ai-ml/ai-ml-learning-resources/model-adaptation/preference-and-alignment-training/preference-and-alignment-training)
