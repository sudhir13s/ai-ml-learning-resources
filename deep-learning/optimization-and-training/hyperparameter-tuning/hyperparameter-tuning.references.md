...
- The validation protocol (leak-free model selection): [Cross-Validation](/ai-ml/ai-ml-learning-resources/classical-machine-learning/model-selection-and-evaluation/cross-validation/cross-validation)
- The classical-ML side of the same problem: [Hyperparameter Search — a Bridge](/ai-ml/ai-ml-learning-resources/classical-machine-learning/model-selection-and-evaluation/hyperparameter-search-a-bridge/hyperparameter-search-a-bridge) — grid, random, and Bayesian search framed for models that fit in minutes, where an exhaustive sweep is still affordable
