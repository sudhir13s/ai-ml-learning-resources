...
> Companion link library for **[Transformer Architecture](transformer-architecture.md)** (the concept page). External sources *and* internal links to related pages on this platform, kept separate so it can be reused as a standalone reference list. Grouped by type, best-first. Every entry is from a primary author or a recognized deep explainer — chosen for depth on *this* topic, not popularity.
...
**In this platform**:
- Concept page (full explanation): [Transformer Architecture](transformer-architecture.md)
- Concept depth (the *why*): [ai-ml-intuitions 4.15 The Transformer Block](../../../../ai-ml-intuitions/architectural-mechanisms/composition/transformer-block-intuition.md) · [4.08 Multi-Head Attention](../../../../ai-ml-intuitions/architectural-mechanisms/attention-and-routing/multi-head-attention-intuition.md) · [1.03 Positional Encoding](../../../../ai-ml-intuitions/representation/embedding-spaces/positional-representations-intuition.md)
- Core component: [15 Attention Mechanism](../attention-mechanism/attention-mechanism.md) — the operation at the heart of every block (the math is derived there)
- Block internals: [11 Normalization](../../stabilization-and-architectural-blocks/normalization/normalization.md) (LayerNorm / RMSNorm, pre- vs post-norm) · [18 Residual / Skip Connections](../../stabilization-and-architectural-blocks/residual-skip-connections/residual-skip-connections.md) (the residual stream) · [03 Activation Functions](../../stabilization-and-architectural-blocks/activation-functions/activation-functions.md) (ReLU → GELU → SwiGLU in the FFN) · [17 Positional Encoding](../positional-encoding/positional-encoding.md)
- Prerequisite: [14 RNN / LSTM / GRU](../../neural-architectures/rnn-lstm-gru/rnn-lstm-gru.md) (what the transformer replaced)
- At scale / inference: [KV Cache](../../../llms-applications-and-agents/inference-and-runtime/kv-cache/kv-cache.md) · [Efficient Attention (FlashAttention)](../efficient-attention/efficient-attention.md)
- Field overview: [Deep Learning](../../README.md) · related: [06. NLP](../../../modalities-and-generative-models/natural-language-processing/README.md) · [LLMs, Applications and Agents](../../../llms-applications-and-agents/README.md)
