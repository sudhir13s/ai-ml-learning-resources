...
- The joint-embedding predictive architecture (JEPA) line is owned by [JEPA Foundations](/ai-ml/ai-ml-learning-resources/world-models-and-embodied-ai/predictive-representation-models/jepa-foundations/jepa-foundations); this page covers only its self-distillation ancestry.
- Related: [Autoencoders](/ai-ml/ai-ml-learning-resources/models-and-architectures/classic-architectures/autoencoders/autoencoders) · [Normalization](/ai-ml/ai-ml-learning-resources/deep-learning/stabilization-and-architectural-blocks/normalization/normalization)
