...
- The loop those decisions sit in: [The Training Loop](/ai-ml/ai-ml-learning-resources/model-building/pretraining/pretraining-the-training-loop) — mixed precision and the memory bill, worked on a model you can trace
