...
2. **Learn the maturity ladder** — read [Google: MLOps levels 0/1/2](https://cloud.google.com/architecture/mlops-continuous-delivery-and-automation-pipelines-in-machine-learning), then watch [Principles of Good ML Systems Design](https://www.youtube.com/watch?v=c_AUuTuPA5k). *The 0→1→2 framing is the answer interviewers are listening for; Chip Huyen's seminar supplies the design principles behind it.*
...
- [Full Stack Deep Learning — the course](https://fullstackdeeplearning.com/course/) — **The Full Stack (Charles Frye, Sergey Karayev, Josh Tobin)** — the whole lifecycle taught by practitioners, lectures and notes free.

## Videos
- [Machine Learning Engineering for Production (MLOps)](https://www.youtube.com/watch?v=Ta14KpeZJok) — **DeepLearningAI** — the lifecycle and the production gap, by Andrew Ng's team.
- [Stanford MLSys Seminar Episode 5: Principles of Good ML Systems Design](https://www.youtube.com/watch?v=c_AUuTuPA5k) — **Stanford MLSys Seminars (Chip Huyen)** — the four requirements of an ML system and why the loop is iterative, from the author of *Designing Machine Learning Systems*.
- [A Chat with Andrew on MLOps: From Model-centric to Data-centric AI](https://www.youtube.com/watch?v=06-AZXmwHjo) — **DeepLearningAI (Andrew Ng)** — the mindset shift that defines mature ML practice.
...
- [Building a Generative AI Platform](https://huyenchip.com/2024/07/25/genai-platform.html) — **Chip Huyen** — the same lifecycle redrawn for LLM systems (context, guardrails, routing, observability), the shape most 2026 teams actually operate.
...
## In this platform
- Next concepts: [02 Reproducibility](/ai-ml/ai-ml-learning-resources/operations-and-lifecycle/lifecycle-and-reproducibility/reproducibility/reproducibility) · [03 Experiment Tracking](/ai-ml/ai-ml-learning-resources/operations-and-lifecycle/lifecycle-and-reproducibility/experiment-tracking/experiment-tracking) · [07 CI/CD for ML & CT](/ai-ml/ai-ml-learning-resources/operations-and-lifecycle/release-and-deployment/cicd-for-ml-and-continuous-training/cicd-for-ml-and-continuous-training)
- The top of the maturity ladder, taught in full: [Continuous Training](/ai-ml/ai-ml-learning-resources/operations-and-lifecycle/lifecycle-and-reproducibility/continuous-training/continuous-training)
