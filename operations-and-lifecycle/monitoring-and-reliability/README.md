...
**In this platform**:
- [Agent Safety](/ai-ml/practitioner-workflows/agentic-systems/agent-safety/agent-safety) — the LLM-shaped version of these problems.
- [Calibration and Reliability Diagrams](/ai-ml/ai-ml-learning-resources/classical-machine-learning/model-selection-and-evaluation/calibration-and-reliability-diagrams/calibration-and-reliability-diagrams) — what drift is measured against.
- [CI/CD for ML and Continuous Training](/ai-ml/ai-ml-learning-resources/operations-and-lifecycle/release-and-deployment/cicd-for-ml-and-continuous-training/cicd-for-ml-and-continuous-training) — the response to a detected problem.
- [Continuous Training](/ai-ml/ai-ml-learning-resources/operations-and-lifecycle/lifecycle-and-reproducibility/continuous-training/continuous-training) — what a drift or quality alert ultimately triggers.
- [Cross-Validation](/ai-ml/ai-ml-learning-resources/classical-machine-learning/model-selection-and-evaluation/cross-validation/cross-validation) — what drift is measured against.
...
- [Governance and Economics](/ai-ml/ai-ml-learning-resources/operations-and-lifecycle/governance-and-economics/readme) — sibling sub-areas.
...
- [LLMOps](/ai-ml/ai-ml-learning-resources/operations-and-lifecycle/governance-and-economics/llmops/llmops) — the LLM-shaped version of these problems.
- [Monitoring and Observability workflow](/ai-ml/practitioner-workflows/operations-and-lifecycle/monitoring-and-observability) — doing it rather than reading it.
...
- [Rollback and Recovery for ML Systems](/ai-ml/ai-ml-learning-resources/operations-and-lifecycle/release-and-deployment/rollback-and-recovery-for-ml-systems/rollback-and-recovery-for-ml-systems) — the response to a detected problem.
- [Uncertainty Estimation and Conformal Prediction](/ai-ml/ai-ml-learning-resources/classical-machine-learning/model-selection-and-evaluation/uncertainty-estimation-and-conformal-prediction/uncertainty-estimation-and-conformal-prediction) — what drift is measured against.
