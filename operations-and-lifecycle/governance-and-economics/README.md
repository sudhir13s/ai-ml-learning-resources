...
Model Registry and Governance is a full teaching page with a companion references file. LLMOps and Cost Optimization are resource cards: a plain-words definition, why it matters, and verified sources.

### The control plane

1. [Model Registry and Governance](/ai-ml/ai-ml-learning-resources/operations-and-lifecycle/governance-and-economics/model-registry-and-governance/model-registry-and-governance) — versioned models with aliases, lineage, approvals, model cards and audit trails; why a rollback is a two-second pointer move rather than a rebuild.
...
- [MLflow Model Registry documentation](https://mlflow.org/docs/latest/ml/model-registry/) — **MLflow maintainers** — registry concepts, aliases and the promotion application programming interface, from the reference implementation.
...
**Books**:
- [*Designing Machine Learning Systems* — Ch. 10 "Infrastructure and Tooling"](https://huyenchip.com/mlops/) — **Chip Huyen** — cost, efficiency and the build-versus-buy decisions.
- [*Machine Learning Engineering* — Ch. 8 "Model Deployment"](http://www.mlebook.com/wiki/doku.php) — **Andriy Burkov** — efficiency and resource trade-offs treated concretely.
- [*Site Reliability Engineering* and *The SRE Workbook*](https://sre.google/books/) — **Google** — online; the capacity-planning and efficiency chapters transfer directly to inference fleets.
