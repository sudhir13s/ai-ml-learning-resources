...
animated SVG (loops).](images/rag16_cache_stream.svg)
...
> $c_{\text{full}}$, $c_{\text{hit}}$ reuse [ch12's cost model](/ai-ml/practitioner-workflows/llm-applications/long-context-vs-rag/long-context-vs-rag)
...
[ch4](/ai-ml/ai-ml-learning-resources/data-and-representation/vector-search/vector-search)), and accept that
