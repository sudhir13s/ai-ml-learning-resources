...
- [Canny Edge Detector](https://www.youtube.com/watch?v=hUC1uoigH6s) — **First Principles of Computer Vision (Shree Nayar)** — the full Canny pipeline, beautifully visualized.
- [Linear Image Filters](https://www.youtube.com/watch?v=-LD9MxBUFQo) — **First Principles of Computer Vision (Shree Nayar)** — linear shift-invariant systems and convolution derived before any kernel is named.
- [Convolution Theorem](https://www.youtube.com/watch?v=kQUfKf-vPdI) — **First Principles of Computer Vision (Shree Nayar)** — why filtering in the frequency domain is the same operation, and when that view is the easier one.
...
- Next concepts: [Pooling & Receptive Fields](/ai-ml/ai-ml-learning-resources/modalities-and-generative-models/computer-vision/pooling-and-receptive-fields/pooling-and-receptive-fields) · [Classic CNN Architectures](/ai-ml/ai-ml-learning-resources/modalities-and-generative-models/computer-vision/classic-cnn-architectures/classic-cnn-architectures)
