...
**In this platform**:
- Concept page (full explanation): [Information Retrieval & Semantic Search](information-retrieval-and-semantic-search.md)
- Prior steps (the inputs): [03 Bag-of-Words & TF-IDF](../bag-of-words-and-tf-idf/bag-of-words-and-tf-idf.md) (lexical / BM25 lineage) · [07 Sentence & Document Embeddings](../sentence-and-document-embeddings/sentence-and-document-embeddings.md) (dense vectors)
- Foundations: [k-Nearest-Neighbors](../../../core-machine-learning/supervised-learning/classification/k-nearest-neighbors/k-nearest-neighbors.md) (the search ANN approximates) · [1.06 Vector Similarities — the Scaled Dot-Product](../../../../ai-ml-intuitions/representation/similarity-and-distance/scaled-dot-product-intuition.md) (the scoring function)
- Puts it to work: [11 Question Answering](../question-answering/question-answering.md) (the retriever in open-domain QA) · canonical RAG home [11. RAG & LLM Applications](../../../llms-applications-and-agents/rag-and-knowledge-systems/overview.md) · the *why* [ai-ml-intuitions 8.02 Retrieval-Augmented Generation](../../../../ai-ml-intuitions/memory-retrieval-and-context/retrieval-augmented-generation/rag-intuition.md)
