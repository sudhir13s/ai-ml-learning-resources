...
- Foundation: [Image Representation & Filtering](/ai-ml/ai-ml-learning-resources/multimodal-and-generative-media/computer-vision/image-representation-and-filtering/image-representation-and-filtering) · [Deep Learning › CNNs & Convolution](/ai-ml/ai-ml-learning-resources/models-and-architectures/classic-architectures/cnns-and-convolution/cnns-and-convolution)
- Related: [Optical Flow & Video Understanding](/ai-ml/ai-ml-learning-resources/multimodal-and-generative-media/computer-vision/optical-flow-and-video/optical-flow-and-video) (motion-based geometry) · image generation → [GenAI](/ai-ml/ai-ml-learning-resources/models-and-architectures/generative-model-families/generative-models/readme)
