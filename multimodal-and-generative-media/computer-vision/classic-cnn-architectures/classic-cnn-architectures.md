...
3. **Master the key idea** — watch [Deep Residual Learning (Paper Explained)](https://www.youtube.com/watch?v=GWt6Fu05voI) — **Yannic Kilcher**, then read the ⭐ [ResNet paper](https://arxiv.org/abs/1512.03385). *Residual learning is the most important architectural idea — and a guaranteed interview topic.*
...
5. **See where the lineage went** — read [A ConvNet for the 2020s (ConvNeXt)](https://arxiv.org/abs/2201.03545) — **Liu et al. (2022)**. *ResNet modernized with transformer-era design choices; still a 2026 production backbone.*
6. **Make it concrete** — work through [d2l: Modern CNNs](https://d2l.ai/chapter_convolutional-modern/index.html). *Implement AlexNet/VGG/ResNet blocks to internalize the design.*
...
- [CS231n Lecture 9 — CNN Architectures](https://www.youtube.com/watch?v=DAOcjicFr1Y) — **Stanford University School of Engineering** — the authoritative AlexNet → VGG → GoogLeNet → ResNet walkthrough.
- [Lecture 8: CNN Architectures (EECS 498)](https://www.youtube.com/watch?v=XaZIlVrIO-Q) — **Michigan Online (Justin Johnson)** — the same lineage taught later, with the error-rate/FLOP trade-offs made explicit.
...
- [Lecture 7: Convolutional Networks (EECS 498)](https://www.youtube.com/watch?v=ANyxBVxmdZ0) — **Michigan Online (Justin Johnson)** — the convolution/pooling primitives every backbone on this page is assembled from.
...
- [A ConvNet for the 2020s (ConvNeXt)](https://arxiv.org/abs/2201.03545) — **Liu et al. (2022)** — a ResNet modernized step by step (patchify stem, depthwise 7×7, LayerNorm, GELU) until it matches Swin.
- [ConvNeXt V2: Co-designing and Scaling ConvNets with Masked Autoencoders](https://arxiv.org/abs/2301.00808) — **Woo et al. (2023)** — the self-supervised (masked-autoencoder) recipe that keeps pure convnets competitive in 2026.
...
## In this platform
- Concept depth (the *why*): [ai-ml-intuitions 4.06 Residual / Skip Connections](/ai-ml/ai-ml-intuitions/training-stability/gradient-health/residual-connections-intuition) · [4.01 Batch Normalization](/ai-ml/ai-ml-intuitions/training-stability/normalization/batch-normalization-intuition)
- Foundation: [Deep Learning › CNNs & Convolution](/ai-ml/ai-ml-learning-resources/models-and-architectures/classic-architectures/cnns-and-convolution/cnns-and-convolution) · [Deep Learning › Residual / Skip Connections](/ai-ml/ai-ml-learning-resources/deep-learning/stabilization-and-architectural-blocks/residual-skip-connections/residual-skip-connections)
- Next concepts: [Image Classification](/ai-ml/ai-ml-learning-resources/multimodal-and-generative-media/computer-vision/image-classification/image-classification) · [Transfer Learning for Vision](/ai-ml/ai-ml-learning-resources/multimodal-and-generative-media/computer-vision/transfer-learning-for-vision/transfer-learning-for-vision)
