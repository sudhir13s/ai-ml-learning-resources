...
3. **Read the sources** — ⭐ [CRNN](https://arxiv.org/abs/1507.05717) → [STN-OCR / attention OCR](https://arxiv.org/abs/1707.03985). *The CNN+RNN+CTC architecture and attention-based reading.*
4. **Make it concrete** — run [Tesseract](https://github.com/tesseract-ocr/tesseract) or [EasyOCR](https://github.com/JaidedAI/EasyOCR). *Extract text from a real document end to end.*
5. **See where this went in 2025–26** — read [olmOCR](https://arxiv.org/abs/2502.18443) and [DeepSeek-OCR](https://arxiv.org/abs/2510.18234). *Detection + CRNN pipelines are being replaced by a vision-language model (VLM) that reads the whole page and emits structured text — the failure modes move from character errors to hallucinated content.*
...
- [Lecture 12: Recurrent Networks (EECS 498)](https://www.youtube.com/watch?v=dUzLD91Sj-o) — **Michigan Online (Justin Johnson)** — the sequence decoder half of CRNN, derived properly before CTC is bolted on.
- [Lecture 13: Attention (EECS 498)](https://www.youtube.com/watch?v=YAgjfMR9R_M) — **Michigan Online (Justin Johnson)** — the attention decoder that replaced CTC in TrOCR-style and VLM-based readers.
...
- [olmOCR: Unlocking Trillions of Tokens in PDFs with Vision Language Models](https://arxiv.org/abs/2502.18443) — **Poznanski et al. (2025)** — the open VLM-based pipeline (and its evaluation) that reads PDFs page-first instead of box-by-box.
- [DeepSeek-OCR: Contexts Optical Compression](https://arxiv.org/abs/2510.18234) — **DeepSeek-AI (2025)** — treats a rendered page as a compressed token stream, the sharpest statement of "OCR is now a VLM problem".
- [Qwen2-VL: Enhancing Vision-Language Model's Perception of the World at Any Resolution](https://arxiv.org/abs/2409.12191) — **Wang et al. (2024)** — dynamic-resolution vision encoding, the change that made VLMs competitive at dense small text.
...
## In this platform
- Foundation: [Object Detection](/ai-ml/ai-ml-learning-resources/multimodal-and-generative-media/computer-vision/object-detection/object-detection) (text detection stage) · [Deep Learning › RNN / LSTM / GRU](/ai-ml/ai-ml-learning-resources/models-and-architectures/classic-architectures/rnn-lstm-gru/rnn-lstm-gru) (CRNN's recurrent core)
...
- Related domain: [NLP › Sequence Labeling](/ai-ml/ai-ml-learning-resources/multimodal-and-generative-media/natural-language-processing/sequence-labeling-pos-and-ner/sequence-labeling-pos-and-ner) (CTC is alignment-free sequence labeling)
- Where OCR goes next: [Document and Chart Understanding](/ai-ml/ai-ml-learning-resources/multimodal-and-generative-media/multimodal-learning/document-and-chart-understanding/document-and-chart-understanding) — reading a page for layout, tables, and charts rather than characters
