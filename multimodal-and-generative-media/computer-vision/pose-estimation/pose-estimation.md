...
## In this platform
- Foundation: [Object Detection](/ai-ml/ai-ml-learning-resources/multimodal-and-generative-media/computer-vision/object-detection/object-detection) (top-down pose needs a detector) · [Semantic Segmentation](/ai-ml/ai-ml-learning-resources/multimodal-and-generative-media/computer-vision/semantic-segmentation/semantic-segmentation) (heatmaps are dense prediction)
...
- Related: [Optical Flow & Video Understanding](/ai-ml/ai-ml-learning-resources/multimodal-and-generative-media/computer-vision/optical-flow-and-video/optical-flow-and-video) (pose tracking over time)
