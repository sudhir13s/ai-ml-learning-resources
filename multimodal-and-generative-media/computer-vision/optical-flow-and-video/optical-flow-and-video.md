...
3. **Go coarse-to-fine** — watch [Coarse-to-Fine Flow Estimation (Nayar)](https://www.youtube.com/watch?v=VSSyPskheaE). *Pyramids handle large motion — the practical trick that rescues Lucas–Kanade.*
...
- [Optical Flow Constraint Equation](https://www.youtube.com/watch?v=IjPLZ3hjU1A) — **First Principles of Computer Vision (Shree Nayar)** — brightness constancy derived to one equation in two unknowns, which is exactly the aperture problem.
- [Coarse-to-Fine Flow Estimation](https://www.youtube.com/watch?v=VSSyPskheaE) — **First Principles of Computer Vision (Shree Nayar)** — image pyramids for large motion, the trick every classical tracker uses.
- [Lecture 18: Videos (EECS 498)](https://www.youtube.com/watch?v=A9D6NXBJdwU) — **Michigan Online (Justin Johnson)** — two-stream, 3D convolution, and where explicit flow stops paying for itself.
...
## In this platform
- Foundation: [Image Representation & Filtering](/ai-ml/ai-ml-learning-resources/multimodal-and-generative-media/computer-vision/image-representation-and-filtering/image-representation-and-filtering) (flow uses image gradients) · [Deep Learning › CNNs & Convolution](/ai-ml/ai-ml-learning-resources/models-and-architectures/classic-architectures/cnns-and-convolution/cnns-and-convolution)
- Related: [Pose Estimation](/ai-ml/ai-ml-learning-resources/multimodal-and-generative-media/computer-vision/pose-estimation/pose-estimation) (pose tracking over frames) · [3D & Depth Estimation](/ai-ml/ai-ml-learning-resources/multimodal-and-generative-media/computer-vision/3d-and-depth-estimation/3d-and-depth-estimation)
- Goes deeper: [Video Representations & Temporal Modeling](/ai-ml/ai-ml-learning-resources/multimodal-and-generative-media/video-understanding/video-representations-and-temporal-modeling/video-representations-and-temporal-modeling) — how flow, 3D convolutions, and two-stream designs became modern video backbones
