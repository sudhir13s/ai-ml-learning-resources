...
- [CS231n Winter 2016 Lecture 11 — ConvNets in practice](https://www.youtube.com/watch?v=pA4BsUK3oP4) — **Andrej Karpathy** — the practical transfer-learning playbook: which layers to freeze, what learning rate to use on the new head, and why.
...
- Foundation: [Classic CNN Architectures](/ai-ml/ai-ml-learning-resources/multimodal-and-generative-media/computer-vision/classic-cnn-architectures/classic-cnn-architectures) (the backbones you transfer)
- Next concepts: [Data Augmentation](/ai-ml/ai-ml-learning-resources/multimodal-and-generative-media/computer-vision/data-augmentation/data-augmentation) · [Self-Supervised Vision](/ai-ml/ai-ml-learning-resources/multimodal-and-generative-media/computer-vision/self-supervised-vision/self-supervised-vision)
