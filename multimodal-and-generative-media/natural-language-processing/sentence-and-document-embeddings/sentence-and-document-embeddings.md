...
This page is the canonical deep-dive; it leans on three neighbors rather than repeating them — **[word embeddings](/ai-ml/ai-ml-learning-resources/multimodal-and-generative-media/natural-language-processing/word-embeddings-word2vec-glove-fasttext/word-embeddings-word2vec-glove-fasttext)** (the static vectors we'll average), **[contextual embeddings (ELMo · BERT)](/ai-ml/ai-ml-learning-resources/multimodal-and-generative-media/natural-language-processing/contextual-embeddings-elmo-bert/contextual-embeddings-elmo-bert)** (the token-level vectors we'll pool), and **[contrastive / self-supervised learning](/ai-ml/ai-ml-learning-resources/deep-learning/self-supervised-learning/contrastive-self-supervised-learning/contrastive-self-supervised-learning)** (the InfoNCE machinery SimCSE reuses). Where it ends — **[information retrieval & semantic search](/ai-ml/ai-ml-learning-resources/multimodal-and-generative-media/natural-language-processing/information-retrieval-and-semantic-search/information-retrieval-and-semantic-search)** — is its own page; we build the *encoder* here and hand off the *index* there.
...
**→ [Sentence & Document Embeddings — references and further reading](/ai-ml/ai-ml-learning-resources/multimodal-and-generative-media/natural-language-processing/sentence-and-document-embeddings/sentence-and-document-embeddings#references-further-reading)**
