...
- Related: [Decoding Strategies (how the text being scored is produced)](/ai-ml/ai-ml-learning-resources/multimodal-and-generative-media/natural-language-processing/decoding-strategies/decoding-strategies) · [Preference and Alignment Training (human preference data & A/B eval)](/ai-ml/ai-ml-learning-resources/model-adaptation/preference-and-alignment-training/preference-and-alignment-training)
