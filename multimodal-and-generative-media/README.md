...
- Doing it rather than reading it: [Multimodal Pipelines workflow](/ai-ml/practitioner-workflows/llm-applications/multimodal-pipelines) · [Embeddings and Vector Search workflow](/ai-ml/practitioner-workflows/data-and-inputs/embeddings-and-vector-search)
...
- Where these representations get used: [Embedding Models](/ai-ml/ai-ml-learning-resources/data-and-representation/embedding-models/embedding-models) · [Vision-Language-Action Models](/ai-ml/ai-ml-learning-resources/world-models-and-embodied-ai/embodied-intelligence/vision-language-action-models/vision-language-action-models)
