...
- Doing it rather than reading it: [Experiment Tracking workflow](/ai-ml/practitioner-workflows/training-and-adaptation/experiment-tracking) · [MLOps and Deployment workflow](/ai-ml/practitioner-workflows/production-lifecycle/mlops-and-deployment)
