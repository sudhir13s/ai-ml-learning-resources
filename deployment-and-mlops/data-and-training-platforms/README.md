...
> cost — is its own sub-area, [Training Infrastructure](/ai-ml/ai-ml-learning-resources/deployment-and-mlops/training-infrastructure/readme).

**Start here:** [Feature Stores](/ai-ml/ai-ml-learning-resources/deployment-and-mlops/data-and-training-platforms/feature-stores/feature-stores) — the problem it solves (train/serve skew) is the reason the rest of the data platform exists.
...
- The compute plane: [Training Infrastructure](/ai-ml/ai-ml-learning-resources/deployment-and-mlops/training-infrastructure/readme)
