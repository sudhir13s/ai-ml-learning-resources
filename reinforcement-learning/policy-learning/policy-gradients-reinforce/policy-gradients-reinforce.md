...
We build the estimator from the ground up, defining every symbol and connecting each term to the intuition. The MDP machinery is recapped, not re-derived — see [MDPs](/ai-ml/ai-ml-learning-resources/reinforcement-learning/foundations/markov-decision-processes/markov-decision-processes).
