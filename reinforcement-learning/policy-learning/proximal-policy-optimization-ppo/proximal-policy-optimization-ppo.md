...
- [Deep RL Bootcamp — Core Lecture 4a: Policy Gradients and Actor-Critic](https://sites.google.com/view/deep-rl-bootcamp/lectures) — **Pieter Abbeel (Berkeley Deep RL Bootcamp, 2017)** — surrogate objectives and advantage estimation, from the official bootcamp page.
...
- Prereq: [11 TRPO](/ai-ml/ai-ml-learning-resources/reinforcement-learning/policy-learning/trust-region-policy-optimization-trpo/trust-region-policy-optimization-trpo) · [10 Actor-Critic](/ai-ml/ai-ml-learning-resources/reinforcement-learning/policy-learning/actor-critic-a2c-a3c/actor-critic-a2c-a3c)
...
- Where PPO went next (2024–26): [Reinforcement Learning for Reasoning — GRPO and RLVR](/ai-ml/ai-ml-learning-resources/model-adaptation/reinforcement-learning-posttraining/reinforcement-learning-posttraining) — GRPO drops the value network and replaces the learned baseline with a group-relative one; the clipped surrogate on this page is still the core.
