...
- [Berkeley CS285 — Model-Based RL & Planning](http://rail.eecs.berkeley.edu/deeprlcourse/) — **UC Berkeley (Sergey Levine)** — learned dynamics, MPC, and uncertainty-aware models.
...
- Prereq: [03 Dynamic Programming](/ai-ml/ai-ml-learning-resources/reinforcement-learning/foundations/dynamic-programming-value-and-policy-iteration/dynamic-programming-value-and-policy-iteration) · Contrast: [06 Q-Learning](/ai-ml/ai-ml-learning-resources/reinforcement-learning/value-based-learning/q-learning/q-learning) (model-free)
- Deep dive (learned latent models): [Imagination-Based Learning (Dreamer)](/ai-ml/ai-ml-learning-resources/world-models-and-embodied-ai/learning-and-planning/imagination-based-learning-dreamer/imagination-based-learning-dreamer) — the Dreamer line, from PlaNet's latent dynamics to Dreamer 4's offline world model.
