...
## Courses (free)
- [Berkeley CS285 — Multi-Agent / Advanced Topics](http://rail.eecs.berkeley.edu/deeprlcourse/) — **UC Berkeley (Sergey Levine)** — multi-agent settings and the non-stationarity problem.
...
- Prereq: [10 Actor-Critic](/ai-ml/ai-ml-learning-resources/reinforcement-learning/policy-learning/actor-critic-a2c-a3c/actor-critic-a2c-a3c) · [13 Continuous Control (DDPG/TD3/SAC)](/ai-ml/ai-ml-learning-resources/reinforcement-learning/policy-learning/continuous-control-ddpg-td3-sac/continuous-control-ddpg-td3-sac)
