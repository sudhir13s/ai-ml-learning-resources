...
3. **Watch the lecture** — [Deep RL Bootcamp — Core Lecture 5: Natural Policy Gradients, TRPO, PPO](https://sites.google.com/view/deep-rl-bootcamp/lectures). *John Schulman (the author) walks through natural gradients → TRPO → PPO; video and slides on the official bootcamp page.*
...
- [Berkeley CS285 — Advanced Policy Gradients](http://rail.eecs.berkeley.edu/deeprlcourse/) — **UC Berkeley (Sergey Levine)** — natural gradients, trust regions, and the monotonic-improvement bound.
...
## Videos
- [Deep RL Bootcamp — Core Lecture 5: Natural Policy Gradients, TRPO, PPO](https://sites.google.com/view/deep-rl-bootcamp/lectures) — **John Schulman (Berkeley Deep RL Bootcamp, 2017)** — the author derives TRPO from the natural gradient; video and slides on the official bootcamp page.
...
- [Deep RL Bootcamp — Core Lecture 4a: Policy Gradients and Actor-Critic](https://sites.google.com/view/deep-rl-bootcamp/lectures) — **Pieter Abbeel (Berkeley Deep RL Bootcamp, 2017)** — the surrogate-objective groundwork, from the official bootcamp page.
...
- [Approximately Optimal Approximate RL (CPI)](https://www.cs.cmu.edu/afs/cs/Web/People/jcl/papers/aoarl/Final.pdf) — **Kakade & Langford (2002)** — conservative policy iteration; the improvement bound TRPO builds on.
...
- Prereq: [10 Actor-Critic](/ai-ml/ai-ml-learning-resources/core-machine-learning/reinforcement-learning/policy-learning/actor-critic-a2c-a3c/actor-critic-a2c-a3c) · Successor: [12 PPO](/ai-ml/ai-ml-learning-resources/core-machine-learning/reinforcement-learning/policy-learning/proximal-policy-optimization-ppo/proximal-policy-optimization-ppo)
