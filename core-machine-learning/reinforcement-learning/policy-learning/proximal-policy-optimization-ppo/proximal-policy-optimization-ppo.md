...
- Where PPO went next (2024–26): [Reinforcement Learning for Reasoning — GRPO and RLVR](/ai-ml/ai-ml-learning-resources/llms-applications-and-agents/training-and-adaptation/reinforcement-learning-for-reasoning-grpo-and-rlvr/reinforcement-learning-for-reasoning-grpo-and-rlvr) — GRPO drops the value network and replaces the learned baseline with a group-relative one; the clipped surrogate on this page is still the core.
