...
- [Pandas Tutorials (full playlist)](https://www.youtube.com/playlist?list=PL-osiE80TeTsWmV9i9c58mdDCSskIFdDS) — **Corey Schafer** — the complete series: indexing, filtering, `groupby`, missing data, dates; one operation per episode.
- [Introduction to Numerical Computing with NumPy](https://www.youtube.com/watch?v=ZB7BZMhfPgk) — **Enthought** — the NumPy foundation pandas is built on; do this first if arrays are new.
...
- [pandas time series and date functionality](https://pandas.pydata.org/docs/user_guide/timeseries.html) — **pandas team** — resampling, offsets and timezone handling; the part of the API that silently corrupts results when skipped.
- [Polars user guide](https://docs.pola.rs/) — **Polars** — the columnar, lazy alternative many teams now reach for on larger-than-memory tables; worth knowing where its API diverges from pandas.
...
## In this platform
- Related domain: [Data Preparation](/ai-ml/ai-ml-learning-resources/data-and-representation/data-preparation/readme) · [Supervised Learning](/ai-ml/ai-ml-learning-resources/classical-machine-learning/supervised-learning/readme)
