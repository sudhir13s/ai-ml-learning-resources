...
4. **Reference & practice** — use [Paul's Online Notes: The Gradient Vector](https://tutorial.math.lamar.edu/Classes/CalcIII/DirectionalDeriv.aspx) and Khan exercises. *Solidify computation and the steepest-ascent property.*
5. **Connect to ML** — read [ai-ml-intuitions 2.01 Partial Derivatives & the Gradient](/ai-ml/ai-ml-intuitions/learning-and-optimization/gradients-and-credit-assignment/partial-derivatives-and-gradients-intuition). *Where the gradient becomes the training signal.*

## References

- **In this platform**:
  - [Gradient Descent — theory](/ai-ml/ai-ml-learning-resources/foundations/mathematical-foundations/gradient-descent-theory/gradient-descent-theory) — builds directly on this page: the gradient put to work.
  - [Jacobian & Hessian](/ai-ml/ai-ml-learning-resources/foundations/mathematical-foundations/jacobian-and-hessian/jacobian-and-hessian) — builds directly on this page: derivatives of vector functions and second derivatives.
  - [Partial Derivatives & the Gradient](/ai-ml/ai-ml-intuitions/learning-and-optimization/gradients-and-credit-assignment/partial-derivatives-and-gradients-intuition) — the intuition, where the gradient becomes the training signal.
  - [The Chain Rule](/ai-ml/ai-ml-learning-resources/foundations/mathematical-foundations/the-chain-rule/the-chain-rule) — builds directly on this page: differentiating compositions.
...
- **Videos**:
  - [Essence of calculus (full playlist)](https://www.youtube.com/playlist?list=PLZHQObOWTQDMsr9K-rj53DwVRMYO3t5Yr) — **3Blue1Brown** — the whole subject in order, for any gaps the single videos leave.
  ...
  - [Mathematics for Machine Learning: What is Gradient?](https://www.youtube.com/watch?v=tqdeAH7azOI) — **Dr. Data Science** — the same object computed numerically in NumPy, which is how you will actually meet it in code.
...
- **Articles**:
  ...
  - [Paul's Online Notes — Directional Derivatives and the Gradient Vector](https://tutorial.math.lamar.edu/Classes/CalcIII/DirectionalDeriv.aspx) — **Paul Dawkins** — the gradient and directional derivatives, with worked examples.
- **Books**:
  ...
  - [Mathematics for Machine Learning — **Ch. 5 (Vector Calculus)**](https://mml-book.github.io/book/mml-book.pdf) — **Deisenroth, Faisal & Ong** — derivatives, partial derivatives, gradient rules, and the build-up to backprop.
</content>
