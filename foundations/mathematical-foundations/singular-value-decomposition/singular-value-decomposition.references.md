...
- [Principal Component Analysis (PCA), Step-by-Step](https://www.youtube.com/watch?v=FgakZw6K1QQ) — **StatQuest with Josh Starmer** — PCA explained plainly; the sister view of truncated SVD.
- [Understanding SVD with Python: `numpy.linalg.svd`](https://www.youtube.com/watch?v=5d67893GJao) — **Dr. Data Science** — the decomposition computed and reassembled in NumPy, including the shape conventions that trip people up on first use.
...
- Applied downstream: dimensionality reduction and latent factors → [Unsupervised Learning](/ai-ml/ai-ml-learning-resources/classical-machine-learning/unsupervised-learning/readme); low-rank adaptation of LLM weights → [LoRA & PEFT](/ai-ml/ai-ml-learning-resources/model-adaptation/lora-and-parameter-efficient-fine-tuning/lora-and-parameter-efficient-fine-tuning)
