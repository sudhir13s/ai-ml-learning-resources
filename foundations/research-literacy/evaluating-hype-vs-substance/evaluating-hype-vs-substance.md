...
## Videos
- [How To Read AI Research Papers Effectively](https://www.youtube.com/watch?v=K6Wui3mn-uI) — **DeepLearningAI** — reading the eval/limitations critically is the core anti-hype skill.
- [Deep Dive into LLMs like ChatGPT](https://www.youtube.com/watch?v=7xTGNNLPyMI) — **Andrej Karpathy** — a first-principles account of what these models are actually doing, including hallucination and eval; the best inoculation against demo-driven claims.
- [How to Stay Up-to-date in AI/ML Without Losing Your Mind](https://www.youtube.com/watch?v=KIm70L1X32E) — **Marina Wyss - AI & Machine Learning** — filtering signal from noise as a habit, not a one-off.
...
- [Are Emergent Abilities of Large Language Models a Mirage?](https://arxiv.org/abs/2304.15004) — **Schaeffer, Miranda & Koyejo (2023), NeurIPS best paper** — shows how a discontinuous metric manufactures a "sudden capability"; the sharpest lesson in reading a curve before believing it.
- [The Leaderboard Illusion](https://arxiv.org/abs/2504.20879) — **Singh et al. (2025)** — how private testing, selective disclosure and unequal sampling distort arena rankings; required reading before quoting a 2026 leaderboard.
...
- Evaluation rigor lives in: [LLMs, Applications and Agents](/ai-ml/ai-ml-learning-resources/llms-applications-and-agents/readme) · [12. Deployment & MLOps](/ai-ml/ai-ml-learning-resources/operations-and-lifecycle/readme)
