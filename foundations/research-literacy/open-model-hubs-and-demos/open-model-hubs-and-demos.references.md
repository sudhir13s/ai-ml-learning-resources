---
id: "21-frontier/model-hubs-and-demos/references"
topic: "Open Model Hubs & Demos (Hugging Face / Spaces) — References"
parent: "21-frontier/model-hubs-and-demos"
type: references
updated: 2026-09-14
---

# Open Model Hubs & Demos (Hugging Face / Spaces) — references

> Companion link library for **[Open Model Hubs & Demos (Hugging Face / Spaces)](/ai-ml/ai-ml-learning-resources/foundations/research-literacy/open-model-hubs-and-demos/open-model-hubs-and-demos)** (the teaching page). External sources and internal links, grouped by type, alphabetical within each group.
...
- [07 Reproducing Papers (code)](/ai-ml/ai-ml-learning-resources/foundations/research-literacy/reproducing-papers-code/reproducing-papers-code) — pair with.
- [10. GenAI](/ai-ml/ai-ml-learning-resources/models-and-architectures/generative-model-families/generative-models/readme) — build on these models.
...
- [16. RAG & LLM Applications](/ai-ml/practitioner-workflows/llm-applications/rag-foundations/rag-foundations) — build on these models.
- [Frontier & Staying Current — concepts](/ai-ml/ai-ml-learning-resources/foundations/research-literacy/readme) — per-concept index.
- [LLMs, Applications and Agents](/ai-ml/ai-ml-learning-resources/models-and-architectures/large-language-models/readme) — build on these models.
...
**Courses**:
- [Hugging Face — LLM Course](https://huggingface.co/learn/llm-course/chapter1/1) — **Hugging Face** — the 2025 rewrite of the official free course: Hub, Transformers, fine-tuning, and inference end to end.

**Articles**:
- [Hugging Face blog](https://huggingface.co/blog) — **Hugging Face** — release notes and walkthroughs for new open models as they land.
- [Hugging Face Papers](https://huggingface.co/papers) — **Hugging Face** — many top papers ship with a model or demo you can try the same day.
- [ModelScope models](https://modelscope.cn/models) — **Alibaba / ModelScope** — the main non-Western hub; where several strong open Chinese models (Qwen, GLM lineages) land first.
- [Ollama model library](https://ollama.com/library) — **Ollama** — the curated set of open models packaged for one-command local runs, with quantized sizes listed.
...
**Documentation**:
- [GGUF on the Hub](https://huggingface.co/docs/hub/gguf) — **Hugging Face** — the quantized single-file format local runners consume; the counterpart to `safetensors` for served weights.
