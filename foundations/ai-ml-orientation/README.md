...
- Doing it rather than reading it: [Data Preparation workflow](/ai-ml/practitioner-workflows/data-and-inputs/data-preparation) · [Model Training workflow](/ai-ml/practitioner-workflows/training-and-adaptation/model-training)
